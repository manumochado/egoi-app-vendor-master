...
class RestaurantProvider extends ChangeNotifier {
  ...
  Future addProductImage(XFile pickedLogo, String type, Function callback,
      [List<String> productImage = const []]) async {
    ...
    if (response.response != null && response.response.statusCode == 200) {
      ...
      callback(true, name, type, productImage);
      notifyListeners();
    } else {
      _isLoading = false;
      String errorMessage;

...
class _AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  route(
      bool isRoute, String name, String type, List<String> productImage) async {
    if (isRoute) {
      //TOTAL DE IMAGENES EN EL PROVIDER
          ...
          child: Padding(
            ...
            child: Consumer<RestaurantProvider>(
              builder: (context, resProvider, child) {
                print('product image: ${resProvider.productImage}');
                List<int> _brandIds = [];
                List<int> _colors = [];
                _brandIds.add(0);
                _colors.add(0);
                  ...
                  if (_update) {
                    if (brand == 0) {
                      resProvider.setBrandIndex(
                          _brandIds.indexOf(_product.brandId), false);
                      brand++;
                    }
                  }
                }
                  ...
                  child: (resProvider.attributeList != null &&
                      ...
                      ? Column(
                          ...
                          children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                          ...
                                          style:
                                              robotoRegularForAddProductHeading),
                                      SizedBox(
                                        height: 5,
                                      ),
                                      Container(
                                        ...
                                        child: DropdownButton<int>(
                                          ...
                                          items: resProvider.subCategoryIds
                                              .map((int value) {
                                            return DropdownMenuItem<int>(
                                              value: resProvider.subCategoryIds
                                                  .indexOf(value),
                                              child: Text(value != 0
                                                  ? resProvider
                                                      .subCategoryList[
                                          ...
                                          onChanged: (int value) {
                                            resProvider.setSubCategoryIndex(
                                                value, true);
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButton<int>(
                                          ...
                                          items: resProvider.subSubCategoryIds
                                              .map((int value) {
                                            return DropdownMenuItem<int>(
                                              value: resProvider
                                                  .subSubCategoryIds
                                          ...
                                          onChanged: (int value) {
                                            resProvider.setSubSubCategoryIndex(
                                                value, true);
                                          },
                                          isExpanded: true,
                                          underline: SizedBox(),
                                ...
                                Flexible(
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      Text(getTranslated('unit', context),
                                          style:
                                              robotoRegularForAddProductHeading),
                                      SizedBox(
                                        height: 5,
                            ...
                            SizedBox(
                                height:
                                    resProvider.selectedColor.length != null &&
                                            resProvider.selectedColor.length > 0
                                        ? Dimensions.PADDING_SIZE_SMALL
                                        : 0),
                            SizedBox(
                            ...
                            AttributeView(
                                product: widget.product, colorOn: false),
                            ...
                            Row(children: [
                              ...
                              Expanded(
                                  child: Column(
                                    ...
                                    Text(
                                      getTranslated(
                                          'shipping_cost_multiply', context),
                                      style: robotoRegular.copyWith(
                                          fontSize: Dimensions.FONT_SIZE_SMALL,
                                          color:
                                              Theme.of(context).disabledColor),
                                    ...
                                    Switch(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        print(
                                            '===IsMultiply=>${resProvider.isMultiply}');
                                      },
                                      activeColor:
                                          Theme.of(context).primaryColor,
                                      inactiveTrackColor: Colors.grey,
                            ...
                            Text(getTranslated('seo_section', context),
                                style: robotoRegularMainHeadingAddProduct),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            ...
                            ConstrainedBox(
                                constraints:
                                    resProvider.productImage.length >= 4
                                        ? BoxConstraints(
                                            maxHeight: (double.parse(resProvider
                                                        .productImage.length
                                                        .toString()) /
                                                    2.3) *
                                                80)
                                      ...
                                      if (_unitPriceController.text
                                        ...
                                        String _discount =
                                            _discountController != null
                                                ? _discountController.text
                                                    .trim()
                                                : '0.0';
                                        String _tax = _taxController != null
                                        ...
                                        String _purchasePrice =
                                            _purchasePriceController.text
                                                .trim();
                                        String _unit =
                                            _unitValue.toString().trim();
                                        String _brandId =
                                            _brandIds[resProvider.brandIndex]
                                                .toString();
                                        String _metaTitle =
                                            _seoTitleController.text.trim();
                                        ...
                                        int _multi =
                                            int.parse(_multiPlyWithQuantity);
                                        ...
                                        if (_unitPrice.isEmpty) {
                                          showCustomSnackBar(
                                              getTranslated(
                                                  'enter_unit_price', context),
                                              context);
                                        } else if (_purchasePrice.isEmpty) {
                                          showCustomSnackBar(
                                              getTranslated(
                                                  'enter_purchase_price',
                                                  context),
                                              context);
                                        } else if (_currentStock.isEmpty) {
                                          showCustomSnackBar(
                                              getTranslated(
                                                  'enter_total_quantity',
                                                  context),
                                              context);
                                        }
                                        ...
                                        // }
                                          ...
                                          _product.unitPrice = PriceConverter
                                              .systemCurrencyToDefaultCurrency(
                                                  double.parse(_unitPrice),
                                                  context);
                                          _product.purchasePrice = PriceConverter
                                              .systemCurrencyToDefaultCurrency(
                                                  double.parse(_purchasePrice),
                                                  context);
                                          _product.discount = resProvider
                                                      .discountTypeIndex ==
                                                  0
                                              ? double.parse(_discount)
                                              : PriceConverter
                                                  .systemCurrencyToDefaultCurrency(
                                                      double.parse(_discount),
                                                      context);
                                          ...
                                          _product.shippingCost = PriceConverter
                                              .systemCurrencyToDefaultCurrency(
                                                  double.parse(_shippingCost),
                                                  context);
                                          _product.multiplyWithQuantity =
                                              _multi;
                                          _product.brandId =
                                              int.parse(_brandId);
                                          ...
                                          _product.categoryIds.add(CategoryIds(
                                              id: resProvider
                                                  ...
                                                  .id
                                                  .toString()));
                                          if (resProvider.subCategoryIndex !=
                                              0) {
                                            _product.categoryIds.add(CategoryIds(
                                                id: resProvider
                                          ...
                                          if (resProvider.colorCodeList !=
                                              null) {
                                            _addProduct.colorCodeList.addAll(
                                          ...
                                          if (_update) {
                                            if (resProvider.pickedLogo ==
                                                        null &&
                                                    resProvider.pickedMeta ==
                                                        null &&
                                                    resProvider.productImage
                                                            .length ==
                                                        0 ||
                                                resProvider.productImage ==
                                                    null) {
